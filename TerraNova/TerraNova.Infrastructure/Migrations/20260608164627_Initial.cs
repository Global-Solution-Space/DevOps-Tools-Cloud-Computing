    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_localizacao = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_produtor = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_tipo = table.Column<Guid>(type: "uuid", nullable: false),
                    tipo_api = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_tipo_plant = table.Column<Guid>(type: "uuid", nullable: false),
                    tipo_plant = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    nome = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    tamanho_total = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false),
                    produtor_id_produtor = table.Column<Guid>(type: "uuid", nullable: false),
                    localizacao_id_localizacao = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_telefone = table.Column<Guid>(type: "uuid", nullable: false),
                    ddd = table.Column<string>(type: "character(2)", fixedLength: true, maxLength: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_api = table.Column<Guid>(type: "uuid", nullable: false),
                    tipo_param = table.Column<string>(type: "character varying(15)", maxLength: 15, nullable: false),
                    data_analise = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    tipo_api_id_tipo = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    nome_talhao = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    volum_area = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false),
                    tipo_plantacao_id_tipo_plant = table.Column<Guid>(type: "uuid", nullable: false),
                    propriedade_id_propriedade = table.Column<Guid>(type: "uuid", nullable: false),
                    localizacao_id_localizacao = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    nivel_alerta = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    resolvido = table.Column<string>(type: "varchar(1)", nullable: false),
                    data_alerta = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    talhao_id_talhao = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
